...
Then(/^we post about that bike to facebook and twitter$/) do
  VCR.use_cassette('cucumber', record: :none) do
    ...
    #visit "https://www.facebook.com/bikeindex"
    #expect(page).to have_content("I Got this bike back because the bike index is awesome!")
    #visit "https://twitter.com/BikeIndex"
    #expect(page).to have_content("I Got this bike back because the bike index is awesome!")
  end
end
