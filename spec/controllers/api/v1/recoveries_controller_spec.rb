    ...
    context "with proper key" do
      it "should create a new Bike in the db and fill it with the correct info" do
        VCR.use_cassette('bikeindex', :record => :new_episodes) do
          post_params = {key: ENV['INCOMING_REQUEST_KEY'], api_url: "https://bikeindex.org/api/v1/bikes/3414", theft_information: {stolen_record_id: 1358, date_stolen: "2014-05-20T01:00:00-05:00", location: "Chicago, IL"}, recovery_information: {date_recovered: "2014-01-29T11:05:17-06:00", recovery_story: nil, tweet: nil}}
